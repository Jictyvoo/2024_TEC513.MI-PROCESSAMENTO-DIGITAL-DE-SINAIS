function functionAnalysis(samples, fIdx1, fIdx2)
    ...
    freqNormal = (-samples / 2:samples / 2 - 1) * (2500 / samples);
    ...
    freqPadded = (-samples:samples - 1) * (2500 / (samples * 2));
    ...
    subplot(3, 1, 2);
    stem(freqNormal, abs(dft_result), 'r', 'filled');
    ...
    subplot(3, 1, 3);
    stem(freqNormal, abs(fft_result), 'b', 'filled');
    ...
    subplot(3, 1, 2);
    stem(freqPadded, abs(dft_result_padded), 'r', 'filled');
    ...
    subplot(3, 1, 3);
    stem(freqPadded, abs(fft_result_padded), 'b', 'filled');
